...
const projects = [
  {
    ...
    imageUrl: `${import.meta.env.BASE_URL}assets/images/prj1.jpg`,
  ...
  },
  {
    ...
    imageUrl: `${import.meta.env.BASE_URL}assets/images/prj2.jpg`,
    link: 'https://glebatv.github.io/University/'
  },
  {
    title: 'Music Player',
    description: 'Music player site with playlists, track management and settings.',
    imageUrl: `${import.meta.env.BASE_URL}assets/images/prj3git.jpg`,
